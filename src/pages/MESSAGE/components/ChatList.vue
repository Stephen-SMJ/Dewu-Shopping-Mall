      ...
      <mt-loadmore :top-method="loadTop" top-pull-text="加载更多" top-drop-text="释放加载" @top-status-change="handleTopChange"
        ...
        <ul style="padding-bottom: 3rem">
          <template v-for="(item, index) in records">
            <li class="chat-mine" :key="index" v-if="item.type==1">
            ...
            <li class="answer" :key="index" v-if="item.type==2">
      ...
      <section class="selbox" :class="showSelBox>0?'show':'hide'">
        <section v-show="showSelBox==1" class="face-box">
          <mt-swipe :auto="0" :continuous="false">
            <mt-swipe-item :key="index" v-for="(n,index) in Math.ceil(EXPS.length/18)">
